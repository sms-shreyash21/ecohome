      ...
      <>
        <div className="main-hero">
          <div className="section-hero-data">
            ...
            <a style={{ fontFamily: 'fantasy' }} href="/ecohome/#/getstarted"><h4>Get Started</h4></a>
          </div>
        ...
        <div style={{ display: 'block', width: '100%' }}>
          <h2 className="greens" style={{ marginTop: 40, marginBottom: 40, fontWeight: 'bold' }}>Why to choose ECO-HOME ???</h2>
          <Carousel>
